...
public class MyProxy {
    ...
    public  static  Object newProxyInstance(Class inface ,MyInvocationHandler h) throws  Exception{
		...
		*/
        ...
        String src =
                "package pattern.structure.proxy.dynamicDemo;" + rt +
                        "import java.lang.reflect.Method;" + rt +
                        "public class My$Proxy0 implements " + inface.getName() + "{" + rt +
                        "    pattern.structure.proxy.dynamicDemo.MyInvocationHandler h;" + rt + //定义成员变量 MyInvocationHandler对象
        ...
        //把源码写到java文件里
        File file = new File("D:\\backup\\platform\\developIdeaWork\\sourceCode\\personal\\src\\main\\java\\pattern\\structure\\proxy\\dynamicDemo\\My$Proxy0.java");
        ...
        URL[] urls = new URL[]{new URL("file:\\" + "D:\\backup\\platform\\developIdeaWork\\sourceCode\\personal\\src\\main\\java")};
        URLClassLoader ul = new URLClassLoader(urls);
        Class c = ul.loadClass("pattern.structure.proxy.dynamicDemo.My$Proxy0");
