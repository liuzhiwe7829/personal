...
public class ResumeManager {
    ...
    public static void setProtoType(String prototypeId, Resume prototype) {
    ...
    public static Resume getPrototype(String prototypeId) throws Exception {

        Resume prototype = map.get(prototypeId);
