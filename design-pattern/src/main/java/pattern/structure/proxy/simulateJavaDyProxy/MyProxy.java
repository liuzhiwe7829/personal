...
public class MyProxy {
    public static Object newProxyInstance() throws Exception {
        String rt = "\n\r";
        //动态代理文件的源码 : 需要动态编译代码
        String src = "package pattern.structure.proxy.simulateJavaDyProxy;" + rt +
                ...
                "}";
        //把源码写到java文件里
        File file = new File("D:\\backup\\platform\\developIdeaWork\\sourceCode\\personal\\src\\main\\java\\pattern\\structure\\proxy\\simulateJavaDyProxy\\TankTimeProxy.java");
        ...
        Class c = ul.loadClass("pattern.structure.proxy.simulateJavaDyProxy.TankTimeProxy");
